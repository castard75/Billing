 ...
 *
 * @ORM\Table(name="interventionsdocument", indexes={@ORM\Index(name="OrigineId", columns={"OrigineId"})})
 * @ORM\Entity
 */
class Interventionsdocument
{
    ...
    public function getOrigineid(): ?Interventions
    {
        return $this->origineid;
    }

    public function setOrigineid(?Interventions $origineid): static
    {
