 ...
 * Customersdocument
 *
 * @ORM\Table(name="customersdocument", indexes={@ORM\Index(name="OrigineId", columns={"OrigineId"})})
 * @ORM\Entity
 */
class Customersdocument
{
    /**
     * @var int
     *
    ...
    public function getOrigineid(): ?Customers
    {
        return $this->origineid;
    }

    public function setOrigineid(?Customers $origineid): static
    {
