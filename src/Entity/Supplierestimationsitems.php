...
/**
 * Supplierestimationsitems
 *
 * @ORM\Table(name="supplierestimationsitems", indexes={@ORM\Index(name="EstimationIdEstimationItem", columns={"EstimationId"}), @ORM\Index(name="ProductIdEstimationItem", columns={"ProductId"})})
 * @ORM\Entity
 */
class Supplierestimationsitems
{
    /**
     * @var int
     *
