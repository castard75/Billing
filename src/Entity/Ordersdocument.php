 ...
 * Ordersdocument
 *
 * @ORM\Table(name="ordersdocument", indexes={@ORM\Index(name="OrigineId", columns={"OrigineId"})})
 * @ORM\Entity
 */
class Ordersdocument
{
    ...
    public function getOrigineid(): ?Orders
    {
        return $this->origineid;
    }

    public function setOrigineid(?Orders $origineid): static
    {
