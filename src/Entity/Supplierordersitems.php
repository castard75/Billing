 ...
 * Supplierordersitems
 *
 * @ORM\Table(name="supplierordersitems", indexes={@ORM\Index(name="OrderIdOrderItem", columns={"OrderId"}), @ORM\Index(name="ProductIdOrderItem", columns={"ProductId"})})
 * @ORM\Entity
 */
class Supplierordersitems
{
    /**
     * @var int
     *
