 ...
 * Equipmentsextras
 *
 * @ORM\Table(name="equipmentsextras", indexes={@ORM\Index(name="EquipmentId", columns={"EquipmentId"})})
 * @ORM\Entity
 */
class Equipmentsextras
{
    /**
     * @var int
     *
    ...
    public function setEquipmentid(?Equipments $equipmentid): static
    {
