 ...
 * Invoicesdocument
 *
 * @ORM\Table(name="invoicesdocument", indexes={@ORM\Index(name="OrigineId", columns={"OrigineId"})})
 * @ORM\Entity
 */
class Invoicesdocument
{
    ...
    public function getOrigineid(): ?Invoices
    {
        return $this->origineid;
    }

    public function setOrigineid(?Invoices $origineid): static
    {
