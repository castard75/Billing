...
/**
 * Supplierinvoicesdocument
 *
 * @ORM\Table(name="supplierinvoicesdocument", indexes={@ORM\Index(name="OrigineId", columns={"OrigineId"})})
 * @ORM\Entity
 */
class Supplierinvoicesdocument
{
    /**
     * @var int
     *
     ...
     *
     * @ORM\ManyToOne(targetEntity="Supplierinvoices")
     * @ORM\JoinColumns({
    ...
    public function getOrigineid(): ?Supplierinvoices
    {
        return $this->origineid;
    }

    public function setOrigineid(?Supplierinvoices $origineid): static
    {
