 ...
 * Controle
 *
 * @ORM\Table(name="controle", indexes={@ORM\Index(name="OrigineId", columns={"OrigineId"}), @ORM\Index(name="ContratID", columns={"ContratID"}), @ORM\Index(name="CustomerId", columns={"CustomerId"}), @ORM\Index(name="SiteId", columns={"SiteId"})})
 * @ORM\Entity
 */
class Controle
{
...
/**
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="TelephoneID", referencedColumnName="Id")
     * })
     */
    private $telephoneid;
