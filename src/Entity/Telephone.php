 ...
 * Telephone
 *
 * @ORM\Table(name="telephone", indexes={@ORM\Index(name="OrigineId", columns={"OrigineId"}), @ORM\Index(name="ContratID", columns={"ContratID"}), @ORM\Index(name="CustomerId", columns={"CustomerId"}), @ORM\Index(name="SiteId", columns={"SiteId"})})
 * @ORM\Entity
 */
class Telephone
{
