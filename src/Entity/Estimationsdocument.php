 ...
 * Estimationsdocument
 *
 * @ORM\Table(name="estimationsdocument", indexes={@ORM\Index(name="OrigineId", columns={"OrigineId"})})
 * @ORM\Entity
 */
class Estimationsdocument
{
    /**
     * @var int
     *
    ...
    public function getOrigineid(): ?Estimations
    {
        return $this->origineid;
    }

    public function setOrigineid(?Estimations $origineid): static
    {
