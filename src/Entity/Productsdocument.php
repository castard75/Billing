 ...
 * Productsdocument
 *
 * @ORM\Table(name="productsdocument", indexes={@ORM\Index(name="OrigineId", columns={"OrigineId"})})
 * @ORM\Entity
 */
class Productsdocument
{
    ...
    public function getOrigineid(): ?Products
    {
        return $this->origineid;
    }

    public function setOrigineid(?Products $origineid): static
    {
