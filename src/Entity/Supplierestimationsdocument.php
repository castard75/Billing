...
/**
 * Supplierestimationsdocument
 *
 * @ORM\Table(name="supplierestimationsdocument", indexes={@ORM\Index(name="OrigineId", columns={"OrigineId"})})
 * @ORM\Entity
 */
class Supplierestimationsdocument
{
    /**
     * @var int
     *
    ...
    /**
     * @var \Supplierestimations
     *
     * @ORM\ManyToOne(targetEntity="Supplierestimations")
     * @ORM\JoinColumns({
    ...
    public function getOrigineid(): ?Supplierestimations
    {
        return $this->origineid;
    }

    public function setOrigineid(?Supplierestimations $origineid): static
    {
