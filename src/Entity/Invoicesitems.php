 ...
 * Invoicesitems
 *
 * @ORM\Table(name="invoicesitems", indexes={@ORM\Index(name="ProductIdInvoiceItem", columns={"ProductId"}), @ORM\Index(name="InvoiceIdInvoiceItem", columns={"InvoiceId"})})
 * @ORM\Entity
 */
class Invoicesitems

{
     ...
     * @var int|null
     *
     * @ORM\Column(name="SpecialCode", type="integer", nullable=true)
     */
    private $specialcode;
     ...
     * @var string|null
     *
     * @ORM\Column(name="Des", type="string", length=100, nullable=true)
     */
    private $des;
     ...
     * @var float
     *
     * @ORM\Column(name="HTAchat", type="float", precision=10, scale=0, nullable=false)
     */
    private $htachat;
     ...
     * @var float
     *
     * @ORM\Column(name="Marge", type="float", precision=10, scale=0, nullable=false)
     */
    private $marge;
